...
namespace MyProducts.AdminSite.Controllers
{
    public class ProductImagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description,ImagURL,ProductId,Active")] ProductImage productImage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description,ImagURL,ProductId,Active")] ProductImage productImage)
        {
            if (ModelState.IsValid)
            {
